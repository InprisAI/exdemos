...
const loadJSON = async () => {
  ...
  const resp = await fetch(`../config/${template}.json`);
  ...
  body.classList.add(CUSTOM.direction);
  body.dir = CUSTOM.direction;
  ...
  loadingSpeech.innerHTML = CUSTOM.loadingSpeech;
  loadingSpeechMobile.innerHTML = CUSTOM.loadingSpeech;

  loading.innerHTML = CUSTOM.loading;
  loadingMobile.innerHTML = CUSTOM.loading;
